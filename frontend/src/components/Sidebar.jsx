    ...
    return (
        <div class="sidebar">
            ...
            <a href="#" class="sidebar-links">
                <svg class="course-svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path
                            ...
                            stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M13 2V14L16.8182 11L20 14V5" stroke="#000000" stroke-width="2" stroke-linecap="round"
            ...
            <a href="#" class="sidebar-links">
                <svg class="add-svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <path d="M15 12L12 12M12 12L9 12M12 12L12 9M12 12L12 15" stroke="#000000" stroke-width="1.5"
            ...
            <a href="#" class="sidebar-links">
                <svg class="student-svg" width="800px" height="800px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
            ...
            <a href="#" class="sidebar-links">
                <svg class="class-svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
