    ...
    return (
        <div>
            ...
            <div className='over-afridi'>
                <div className='green-afridi shadow'>
                    ...
                    <div className='text-in-green'>
                        <div className='greendiv-motive'>
                            ...
                            <h3>{overview.ongoing_course}22 </h3></div>
                    </div>
                </div>
                ...
                <div className='green-afridi shadow'>
                    ...
                    <div className='text-in-green'>
                        <div className='greendiv-motive'>
                            ...
                            <h3>{overview.completed_course}12</h3></div>
                    </div>
                </div>
                ...
                <div className='green-afridi shadow'>
                    ...
                    <div className='text-in-green'>
                        ...
                        <h3>{overview.earned_certificate} 122</h3>
                    </div>
                </div>
            </div>


            <h3 className='cyt'>Courses Your Taking</h3 >
            ...
            <h3 className='cyt2'>Suggestion</h3>
