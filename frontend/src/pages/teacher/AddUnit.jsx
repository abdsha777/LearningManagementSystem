            ...
            </div>
            {
                unitId && (
                    <div className="sectionBody">
...

                        {
                            videos.map((v, idx) => (
                                <div className="sectionBox" key={idx}>
                                    ...
                                    <div className="textbox">
                                        <h3>Duration:</h3>
                                        <p>{v.duration && v.duration.hours > 0 ? `${v.duration.hours} hours` : ""} {v.duration?.minutes} min</p>
                                    </div>
                                    <div className="textbox">
                                        <h3>Description:</h3>
                                        <p>{v.description}</p>
                                    ...
                                    <div className="sectionBtns">
                                        ...
                                        <button className="editBtn deleteBtn" onClick={()=>deleteVideo(v._id)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="27" viewBox="0 0 25 27" fill="none">
                                                <path d="M5.20801 26.625C4.40592 26.625 3.71905 26.3392 3.14738 25.7675C2.57572 25.1958 2.29037 24.5094 2.29134 23.7083V4.75H0.833008V1.83333H8.12467V0.375H16.8747V1.83333H24.1663V4.75H22.708V23.7083C22.708 24.5104 22.4222 25.1973 21.8505 25.769C21.2788 26.3406 20.5925 26.626 19.7913 26.625H5.20801ZM19.7913 4.75H5.20801V23.7083H19.7913V4.75ZM8.12467 20.7917H11.0413V7.66667H8.12467V20.7917ZM13.958 20.7917H16.8747V7.66667H13.958V20.7917Z" fill="black" />
                                            </svg>
                                            Delete
                                        </button>
                                    </div>
                        ...
                        <AddEditVideo
                            handler={<button className='mybutton dashedBtn mr20'>Add Videos</button>}
                            edit={false}
                            token={token}
                            unitId={unitId}
                            refresh={getVideos}
                        ...
                        <button className='mybutton filledBtn'>Change Sequence</button>
                    </div>
                )
            }
        </>
