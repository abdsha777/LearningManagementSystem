    ...
    return (
        <div>
                ...
                <div className="sectionBox">
                    ...
                    </div>
                    {
                        course.courseImg && (
                            <div className="textbox">
                                <h3>Course Image:</h3>
                                <img src={`${endpoint}/img/${course.courseImg}`} alt="courseImg" />
            ...
            <div className="sectionBody">
                        ...
                        return (
                            <div className="sectionBox" key={u._id}>
                                ...
                                <div className="sectionBtns">
                                    ...
                                    <button className="editBtn deleteBtn" onClick={() => deleteUnit(u._id)}>
                ...
                <Link to={'addUnit'}>
                    <button className='mybutton dashedBtn mr20'>Add Unit</button>
                </Link>
            ...
            <div className="sectionBody">
                ...
                <button className='mybutton dashedBtn mr20'>Add Final Test</button>
            </div>
